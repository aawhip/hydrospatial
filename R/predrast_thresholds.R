#' Function to create a raster of cell inundation flow thresholds
#'
#' This function creates a raster where cell values represent the maximum
...
#' the raster stack), it returns 1. Otherwise, it uses the maximum (or last) flow
#' associated with a 0 or NA depth value. Note that the determination of flow thresholds
#' is limited by the flows provided and their associated rasters. For example, if rasters
#' at 100 cfs and 200 cfs are provided but a cell actually inundates at 150 cfs, the
